# Module Imports
from sqlalchemy import Column, create_engine, Engine, ForeignKey, Integer, MetaData, Table, Text
import os
import pandas as pd
...
def create_tables(engine: Engine):
    ...
    locations = Table(
        ...
        Column('former_business_id', Integer, ForeignKey('cities.internal_id'), nullable = False)
    )
