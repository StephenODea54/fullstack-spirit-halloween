                            ...
                            <Card className='mt-6'>
                                <Flex className='md:flex-row' flexDirection='col' justifyContent='between'>
                                    <Flex alignItems='start' flexDirection='col'>
                                        <Title>
                                            Spirit Halloween Locations by{' '}
                                            {view === 'state' ? 'State' : 'Former Business'}
                                        </Title>
                                        <Text>
                                            Top {view === 'state' ? statesLimit : businessLimit} Locations
                                        </Text>
                                    </Flex>
                                    <TabGroup
                                ...
                                <Flex className='mt-12 max-w-[275px]'>
                                    ...
                                    <Select
                                        ...
                                        value={
                                            view === 'state'
                                                ? statesLimit.toString()
                                                : businessLimit.toString()
                                        }>
                                        {LIMITS.map(limit => (
